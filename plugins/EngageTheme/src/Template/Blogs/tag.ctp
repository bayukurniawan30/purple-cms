        ...
        <div class="row">
            <div class="col-md-8 blog-main">
                ...
                <div class="blog-post">
                    ...
                    ?>
                    <a href="<?= $url ?>" title="" class=""><img src="<?= $this->cell('Medias::mediaPath', [$blog->featured, 'image', 'original']) ?>" alt="<?= $blog->title ?>" class="img-fluid"></a>
                    <?php 
                            endif;
                        endif; 
                    ?>
                ...
                <div class="uk-alert-danger" uk-alert>
                    <p>Can't find post for this tag.</p>
                </div>
                <?php
                    endif;
                ?>
