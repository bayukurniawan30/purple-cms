window.CodeMirror = function () {
        ...
        function x(e, t, r, n) {
            ...
            if (!(!n && 0 == t.length && r.from > i.showingFrom && r.to < i.showingTo)) {
                ...
                if (i.showingFrom < c && c - i.showingFrom < 20 && (c = Math.max(o.first, i.showingFrom)), i.showingTo > h && i.showingTo - h < 20 && (h = Math.min(u, i.showingTo)), Vi)
                    for (c = mn(Ir(o, hn(o, c))); u > h && Pr(o, hn(o, h));) ++h;
                var f = [{
                    from: Math.max(i.showingFrom, o.first),
                    to: Math.min(i.showingTo, u)
                }];
                if (f = f[0].from >= f[0].to ? [] : C(f, t), Vi)
                    for (var a = 0; a < f.length; ++a)
                        for (var d, p = f[a]; d = Wr(hn(o, p.to - 1));) {
        ...
        function M(e, t, r, n, i) {
            ...
            if (i) {
                i.alignable = null;
                for (var u, c = !0, h = 0, f = null, d = i.firstChild; d; d = u)
        ...
        function E(e) {
            var t = e.display,
                r = Gt(e.doc.sel.from, e.doc.sel.to);
        ...
        function O(e, t, r) {
            ...
            var o = z(e, t, r),
                l = o > n.first && hn(n, o - 1).stateAfter;
        ...
        function it(e) {
            ...
            if (u)
                for (var f = 0; f < u.length; ++f) u[f].lines.length || Pn(u[f], "hide");
            if (c)
                for (var f = 0; f < c.length; ++f) c[f].lines.length && Pn(c[f], "unhide");
            var d;
            if (--ko || (d = wo, wo = null), t.textChanged && Pn(e, "change", e, t.textChanged), t.cursorActivity && Pn(e, "cursorActivity", e), d)
        ...
        function ft(e, t) {
            var r, n, i = e.doc;
            if (Gt(i.sel.from, i.sel.to)) t && (e.display.prevInput = e.display.input.value = "", Li && !Mi && (e.display.inputHasSelection = null));
            else {
        ...
        function gt(e, t) {
            for (var r = On(t); r != e.wrapper; r = r.parentNode)
        ...
        function yt(e) {
            ...
            if (!Bn(this, e)) {
                ...
                if (!bt(i, e)) {
                    ...
                    else if ($i && $i.time > u - 400 && Gt($i.pos, a)) {
                        c = "double", ji = {
                            time: u,
                            pos: a
                        }, Fn(e);
        ...
        function Wt(e, t, r, n) {
            ...
            if (!(jn(e, "beforeChange") || e.cm && jn(e.cm, "beforeChange")) || (t = Ht(e, t, !0))) {
                ...
                if (i) {
                    for (var o = i.length - 1; o >= 1; --o) It(e, {
                        from: i[o].from,
                        to: i[o].to,
                        text: [""]
                    });
        ...
        function lr(e, t, r, n, i) {
            var o = e.display,
                l = tt(e.display);
            0 > r && (r = 0);
            var s = o.scroller.clientHeight - Co,
            ...
            var p = o.scroller.clientWidth - Co,
        ...
        function hr(e, t, r, n, i) {
            ...
            if ("char" == n) l();
                ...
                for (var f = null, d = "group" == n, p = !0; !(0 > r) || l(!p); p = !1) {
        ...
        function Dr(e, t) {
            ...
            if (!u) {
                ...
                if (g > 0 && s)
                    for (var h = 0; h < s.length; ++h) null == s[h].to && (m || (m = [])).push({
                        from: null,
                        to: null,
                        marker: s[h].marker
                    });
        ...
        function Yr(e, t, r) {
            var n = e.doc.mode,
                i = new kr(t.text, e.options.tabSize);
        ...
        function on(e, t, r) {
            var n = e.markedSpans,
                ...
                o = 0;
            if (n)
                for (var l, s, a, u, c, h, f = i.length, d = 0, p = 1, m = "", g = 0;;) {
                    if (g == d) {
            ...
            for (var r = 0, n = []; r < e.length; ++r) {
                ...
                for (var s = 0; s < o.length; ++s) {
                    ...
                    if (l.push({
                        ...
                        for (var c in u)(a = c.match(/^spans_(\d+)$/)) && Xn(t, Number(a[1])) > -1 && (Kn(l)[c] = u[c], delete u[c])
                }
            }
            return n
        }
        ...
        function Tn(e, t, r, n) {
            for (var i = 0; i < e.length; ++i) {
                for (var o = e[i], l = !0, s = 0; s < o.changes.length; ++s) {
                    var a = o.changes[s];
                    if (o.copied || (a.from = Vt(a.from), a.to = Vt(a.to)), r < a.from.line) a.from.line += n, a.to.line += n;
                    else if (t <= a.to.line) {
                        l = !1;
                        break
                    }
        ...
        function Qn(e) {
            if (Hi) e.selectionStart = 0, e.selectionEnd = e.value.length;
            else try {
                e.select()
            } catch (t) {}
        }
        ...
        e.Pos = Ut, e.prototype = {
            ...
            getTokenTypeAt: function (e) {
                e = Qt(this.doc, e);
                var t = Xr(this, hn(this.doc, e.line)),
                    r = 0,
                    n = (t.length - 1) / 2,
                    i = e.ch;
                if (0 == i) return t[2];
        ...
        function o(e, i) {
            ...
            if ("#" === e.peek() || w && e.match(P)) i.header = !0;
            else if (e.eat(">")) i.indentation++, i.quote = !0;
            else {
                if ("[" === e.peek()) return r(e, i, f);
                if (e.match(H, !0)) return T;
                if (e.match(W, !0) || e.match(I, !0)) i.indentation += 4, i.list = !0;
                else if (t.fencedCodeBlocks && e.match(/^```([\w+#]*)/, !0)) return i.localMode = b(RegExp.$1), i.localMode && (i.localState = i.localMode.startState()), n(e, i, s), L
            }
    ...
    function () {
        ...
        d.reduce = d.foldl = d.inject = function (e, t, r, n) {
            null == e && (e = []), t = p(t, n, 4);
            var i, o = e.length !== +e.length && d.keys(e),
                l = (o || e).length,
                s = 0;
            ...
            if (null == e) return !0;
            t = d.iteratee(t, r);
            var n, i, o = e.length !== +e.length && d.keys(e),
                l = (o || e).length;
            for (n = 0; l > n; n++)
        ...
        var b = function (e, t, r, n) {
            ...
            if ("[object Array]" === i) {
                if (u = e.length, c = u === t.length)
                    for (; u-- && (c = b(e[u], t[u], r, n)););
            } else {
                var h, f = d.keys(e);
                if (u = f.length, c = d.keys(t).length === u)
                    for (; u-- && (h = f[u], c = d.has(t, h) && b(e[h], t[h], r, n)););
            }
    ...
    function () {
        ...
        c.bullet = /(?:[*+-]|\d+\.)/, c.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/, c.item = l(c.item, "gm")(/bull/g, c.bullet)(), c.list = l(c.list)(/bull/g, c.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + c.def.source + ")")(), c.blockquote = l(c.blockquote)("def", c.def)(), c._tag = "(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b", c.html = l(c.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, c._tag)(), c.paragraph = l(c.paragraph)("hr", c.hr)("heading", c.heading)("lheading", c.lheading)("blockquote", c.blockquote)("tag", "<" + c._tag)("def", c.def)(), c.normal = a({}, c), c.gfm = a({}, c.normal, {
            ...
            for (var n, i, o, l, s, a, u, h, f, e = e.replace(/^ +$/gm, ""); e;)
        ...
        h._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/, h._href = /\s*<?([\s\S]*?)>?(?:\s+['"]([\s\S]*?)['"])?\s*/, h.link = l(h.link)("inside", h._inside)("href", h._href)(), h.reflink = l(h.reflink)("inside", h._inside)(), h.normal = a({}, h), h.pedantic = a({}, h.normal, {
            ...
            for (var t, r, n, o, l = ""; e;)
                ...
                if (o = this.rules.tag.exec(e)) !this.inLink && /^<a /i.test(o[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(o[0]) && (this.inLink = !1), e = e.substring(o[0].length), l += this.options.sanitize ? i(o[0]) : o[0];
        ...
        e.loader = "component", e.helper = {}, e.helper.semVerSort = function (e, t) {
            for (var r = e.version.split("."), n = t.version.split("."), i = 0; i < r.length; ++i) {
                ...
                var s = r[i].substr(("" + o).length),
                    a = n[i].substr(("" + l).length);
                if ("" === s && "" !== a) return 1;
                if ("" !== s && "" === a) return -1;
            ...
            (function () {
                ...
                n = "undefined" != typeof Emitter && null !== Emitter ? Emitter : e("component~emitter@1.1.2"), a = function () {}, t = function (e) {
                    ...
                    return h(t, e), t.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached"], t.prototype.defaultOptions = {
                        ...
                        maxfilesexceeded: a,
                        maxfilesreached: a,
                        previewTemplate: '<div class="dz-preview dz-file-preview">\n  <div class="dz-details uk-cover-container">\n    <div class="dz-filename"><span data-dz-name></span></div>\n    <div class="dz-size" data-dz-size></div>\n    <img data-dz-thumbnail uk-cover />\n  </div>\n  <div class="dz-progress"><span class="dz-upload" data-dz-uploadprogress></span></div>\n  <div class="dz-success-mark"><span>✔</span></div>\n  <div class="dz-error-mark"><span>✘</span></div>\n  <div class="dz-error-message"><span data-dz-errormessage></span></div>\n</div>'
                    }, r = function () {
                        var e, t, r, n, i, o, l;
                        ...
                        for ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(t.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length && (n = function (e) {
                                return function () {
                                    return e.hiddenFileInput && document.body.removeChild(e.hiddenFileInput), e.hiddenFileInput = document.createElement("input"), e.hiddenFileInput.setAttribute("type", "file"), (null == e.options.maxFiles || e.options.maxFiles > 1) && e.hiddenFileInput.setAttribute("multiple", "multiple"), e.hiddenFileInput.className = "dz-hidden-input", null != e.options.acceptedFiles && e.hiddenFileInput.setAttribute("accept", e.options.acceptedFiles), null != e.options.capture && e.hiddenFileInput.setAttribute("capture", e.options.capture), e.hiddenFileInput.style.visibility = "hidden", e.hiddenFileInput.style.position = "absolute", e.hiddenFileInput.style.top = "0", e.hiddenFileInput.style.left = "0", e.hiddenFileInput.style.height = "0", e.hiddenFileInput.style.width = "0", document.body.appendChild(e.hiddenFileInput), e.hiddenFileInput.addEventListener("change", function () {
                                        var t, r, i, o;
                                        if (r = e.hiddenFileInput.files, r.length)
                                            for (i = 0, o = r.length; o > i; i++) t = r[i], e.addFile(t);
                                        return n()
                                    })
                                }
                        ...
                        for (t = function (e) {
                                ...
                                for (r = 0, n = e.length; n > r; r++)
                                    if (t = e[r], /(^| )fallback($| )/.test(t.className)) return t
                            }, o = ["div", "form"], n = 0, i = o.length; i > n; n++)
                            if (r = o[n], e = t(this.element.getElementsByTagName(r))) return e
                        ...
                        b.open(this.options.method, this.options.url, !0), b.withCredentials = !!this.options.withCredentials, g = null, o = function (t) {
                            ...
                            return function (r) {
                                ...
                                if (null != r)
                                    for (o = 100 * r.loaded / r.total, l = 0, u = e.length; u > l; l++) n = e[l], n.upload = {
                                        progress: o,
                                        total: r.total,
                                        bytesSent: r.loaded
                                    };
                            ...
                            "X-CSRF-Token": document.getElementById('csrf-ajax-token').value
                        ...
                        if (this.options.uploadMultiple && this.emit("sendingmultiple", e, b, i), "FORM" === this.element.tagName)
...
MdEditor = function () {
    ...
    return t.prototype.updatePreview = function () {
        var e;
        return e = this.editor.getValue(), this.textarea.val(this.editor.getValue()), this.preview.is(":visible") ? (this.preview.html(marked(e), {
            breaks: !0
        }), this._setSections()) : void 0
        ...
        var e, t, r;
        return this.preview.is(":visible") && 0 !== this.markdownSections.length && 0 !== this.previewSections.length ? (t = this.markdownScroll.scrollTop(), r = this.previewScroll.scrollTop(), e = 0, "markdown" === this.scrolling ? Math.abs(t - this.lastMarkdownScrollTop) <= 9 ? !1 : (this.scrolling = !1, this.lastMarkdownScrollTop = t, e = this._scrollTop(t, this.markdownSections, this.previewSections), Math.abs(e - r) <= 9 ? (this.lastPreviewScrollTop = r, !1) : (this.isPreviewMoving = !0, this.previewScroll.stop().animate({
            scrollTop: e
        }, 100, function (e) {
            return function () {
        ...
        return $('<button class="mdeditor_bold">b</button>').appendTo(this.toolbar).click(this.bold), $('<button class="mdeditor_italic">i</button>').appendTo(this.toolbar).click(this.italic), $('<button class="mdeditor_link">l</button>').appendTo(this.toolbar).click(this.link), $('<button class="mdeditor_picture">p</button>').appendTo(this.toolbar).click(this.image), $('<button class="mdeditor_code">c</button>').appendTo(this.toolbar).click(this.code), $('<button class="mdeditor_fullscreen">f</button>').appendTo(this.toolbar).click(this.fullscreen)
