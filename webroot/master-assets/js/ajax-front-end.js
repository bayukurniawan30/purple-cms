        ...
        $ajaxForm.submit(function(event){
            if ($ajaxForm.parsley().isValid()) {
			    ...
			    ajaxFormSubmit.fail(function(jqXHR, textStatus) {
                    ...
                    $ajaxButton.html(ajaxButtonNormalState);
                    if (action == 'notify') {
                        errorContainer.html(jqXHR.statusText + '! Please refresh the page and try again.');
                    }
                    else {
                        errorContainer.html('<div class="alert alert-danger" role="alert"><strong>' + jqXHR.statusText + '!</strong> Please refresh the page and try again.</div>');
                    }
