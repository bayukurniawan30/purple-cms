                ...
                if ($args->getOption('theme_name')) {
                    ...
                    if (!file_exists($path . $themeName . DS . 'detail.json')) {
                        if (strpos($themeName, 'Theme') !== false) {
                            ...
                            $openGraphMetaFile->write("<?php\r\n    if (\$logo == '') {\r\n        if (\$metaImage != '') {\r\n            \$metaImage = \$request->host().\$request->getAttribute(\"webroot\").'uploads/images/original/' . \$metaImage;\r\n        }\r\n        else {\r\n            \$metaImage = '';\r\n        }\r\n    }\r\n    else {\r\n        \$metaImage = \$request->host().\$request->getAttribute(\"webroot\").'uploads/images/original/' . \$logo;\r\n    }\r\n\r\n    // Meta og:locale\r\n    echo \$this->Html->meta(\r\n        'og:locale',\r\n        'en_US'\r\n    );\r\n\r\n    // Meta og:title\r\n    echo \$this->Html->meta(\r\n        'og:title',\r\n        \$this->element('head_title')\r\n    );\r\n\r\n    // Meta og:type\r\n    echo \$this->Html->meta(\r\n        'og:type',\r\n        \$metaOgType\r\n    );\r\n\r\n    // Meta og:image\r\n    echo \$this->Html->meta(\r\n        'og:image',\r\n        \$metaImage\r\n    );\r\n\r\n    // Meta og:video\r\n    echo \$this->Html->meta(\r\n        'og:video',\r\n        ''\r\n    );\r\n\r\n    // Meta og:url\r\n    echo \$this->Html->meta(\r\n        'og:url',\r\n        \$this->Url->build(\$request->getRequestTarget(), true)\r\n    );\r\n\r\n    // Meta og:description\r\n    echo \$this->Html->meta(\r\n        'og:description',\r\n        \$metaDescription\r\n    );\r\n\r\n    // Meta og:site_name\r\n    echo \$this->Html->meta(\r\n        'og:site_name',\r\n        \$siteName\r\n    );\r\n?>");
