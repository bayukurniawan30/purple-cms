    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-toolbar">
                <button type="button" class="btn btn-gradient-primary btn-toolbar-card btn-sm btn-icon-text <?php if ($this->request->getParam('folder') == 'inbox') echo 'active' ?>" onclick="location.href='<?= $folderInboxUrl ?>'">
                <i class="mdi mdi-bell btn-icon-prepend"></i>
                    Inbox
                </button>
                <button type="button" class="btn btn-gradient-danger btn-toolbar-card btn-sm btn-icon-text uk-margin-small-left  <?php if ($this->request->getParam('folder') == 'trash') echo 'active' ?>" onclick="location.href='<?= $folderTrashUrl ?>'">
                                    ...
                                    <div class="uk-width-expand">
                                        <h5 class="uk-comment-title uk-margin-remove">
                                            <a class="uk-link-reset" href="#">
                                                <?= $message->name ?>
                                            </a> <?php if ($message->read == 'Unread'): ?><span class="uk-badge bg-danger unread-badge">Unread</span><?php endif; ?></h5>
