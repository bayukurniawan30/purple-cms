...
<div id="modal-delete-subscriber" class="uk-flex-top purple-modal" uk-modal>
    <div class="uk-modal-dialog uk-margin-auto-vertical">
        <?php
            echo $this->Form->create($subscriberDelete, [
                'id'                    => 'form-delete-subscriber',
                'class'                 => 'pt-3',
                'data-parsley-validate' => '',
