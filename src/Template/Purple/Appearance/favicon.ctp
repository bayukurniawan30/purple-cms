    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-danger button-delete-favicon" data-purple-id="<?= $favicon->id ?>" data-purple-name="<?= $favicon->value ?>" uk-tooltip="Delete Favicon">
                    Delete
                </button>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var deleteBtn = deleteButton('favicon');
            
        var mediaDelete = {
            form            : 'form-delete-favicon', 
            button          : 'button-delete-favicon',
            action          : 'delete', 
