<div class="row">
    <div class="col-md-7 grid-margin">
        <div class="card">
            ...
            <?php
                echo $this->Form->create($adminAdd, [
                    'id'                    => 'form-add-user',
                    'class'                 => '',
                ...
                echo $this->Form->hidden('ds', ['value' => $this->Url->build(['_name' => 'adminUsers'])]);
            ?>
            <div class="card-body">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var userAdd = {
            ...
            redirect        : '<?= $this->Url->build(['_name' => 'adminUsers']); ?>',
            btnNormal       : false,
            btnLoading      : false
        };

        var targetButton = $("#"+userAdd.button);
        targetButton.one('click',function() {
            ajaxSubmit(userAdd.form, userAdd.action, userAdd.redirectType, userAdd.redirect, userAdd.btnNormal, userAdd.btnLoading);
        })
    })
</script>