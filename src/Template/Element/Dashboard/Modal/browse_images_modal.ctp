    ...
    <div class="uk-modal-dialog">
        ...
        <div class="uk-grid-collapse uk-child-width-1-1 uk-flex-middle" uk-grid>
            <div class="uk-animation-slide-top" uk-height-viewport>
                ...
                <div id="load-media-list" class="uk-modal-body uk-height-max-large" style="overflow-y: scroll; position: relative;" data-purple-url="<?= $this->Url->build(["controller" => 'Medias', "action" => "ajaxBrowseImages"]); ?>" data-purple-page-total="<?= $this->Paginator->total() ?>" data-purple-page-limit="<?= $mediaImageLimit ?>" data-purple-multiple="<?= $dataMultiple ?>">
                    <?php
