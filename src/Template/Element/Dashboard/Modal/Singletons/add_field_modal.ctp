    ...
    <div class="uk-modal-dialog uk-margin-auto-vertical">
        <?php
            echo $this->Form->create(NULL, [
                ...
                'url'                   => ['controller' => 'Singletons', 'action' => 'ajaxAddField']
            ]);
        ...
        <div class="uk-modal-body">
                ...
                <?php
                    ...
                    echo $this->Form->select(
                        ...
                        [
                            ...
                            'required' => 'required',
                            'value'    => 'text',
                            'data-purple-component' => 'singleton'
                        ]
                    );
                ?>
            </div>
            ...
            <div class="form-group">
                <div id="error-get-singleton-options" class="uk-alert-danger" uk-alert hidden>
                    ...
                    submitAddField.done(function (data){
                        ...
                        if (status == 'ok') {
                            ...
                            $(".button-edit-component-field").on("click", function() {
                                ...
                                $(modal).find('#error-get-singleton-options').prop('hidden', false);
                                ...
                                $.ajax({
                                    ...
                                    success: function(data){
                                        ...
                                        if (status == 'ok') {
                                            $(modal).find('#error-get-singleton-options').prop('hidden', true);
